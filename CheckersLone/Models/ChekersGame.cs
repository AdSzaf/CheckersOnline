namespace CheckersLone.Models
{
    public class CheckersGame
    {
        ...
        public string CurrentPlayer { get; private set; } = "white"; // "white" lub "black"
        ...
        {
            // Inicjalizacja planszy (tylko pionki)
        ...
        public bool Move(int fromX, int fromY, int toX, int toY)
        {
            ...
            CurrentPlayer = CurrentPlayer == "white" ? "black" : "white"; // Zmiana gracza
            return true;
        }
